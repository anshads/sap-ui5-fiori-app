...
* @Last Modified time: 2014-03-28 15:45:41
*/

jQuery.sap.require("sap.ui.demo.app.util.Formatter");
jQuery.sap.require("sap.ui.demo.app.util.Grouper");
sap.ui.controller("sap.ui.demo.app.view.Master", {
	...
	handleGroup : function (evt) {
		...
		if ("GrossAmount" === key || "LifecycleStatus" === key) { 
			sap.ui.demo.app.util.Grouper.bundle = this.getView().getModel("i18n").getResourceBundle(); 
			var grouper = sap.ui.demo.app.util.Grouper[key]; 
